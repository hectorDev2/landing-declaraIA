    ...
    <div className="container max-w-4xl py-12 md:py-24">
      ...
      <div className="prose prose-slate max-w-none dark:prose-invert">
        ...
        <section className="space-y-4 mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              ...
              número de teléfono y RUC.
            </li>
            <li>
              <strong>Información Tributaria:</strong> Comprobantes de pago,
              facturas, recibos por honorarios y credenciales de acceso a SUNAT
              (Clave SOL) únicamente para fines de sincronización.
            </li>
            <li>
        ...
        <section className="space-y-4 mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Procesar y clasificar tus documentos tributarios automáticamente.
            </li>
            <li>Calcular tus impuestos mensuales y generar reportes.</li>
            <li>Mejorar nuestros algoritmos de inteligencia artificial.</li>
            <li>
              Enviarte notificaciones importantes sobre tus declaraciones y
              vencimientos.
            </li>
          </ul>
        </section>
        ...
        <section className="space-y-4 mb-8">
          ...
          <p>
            ...
            avanzadas para proteger tus datos personales y tributarios contra el
            acceso no autorizado, la pérdida o la alteración. Utilizamos
            encriptación de grado bancario para la transmisión y almacenamiento
            de datos sensibles.
          </p>
        </section>
        ...
        <section className="space-y-4 mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              Con la SUNAT, estrictamente para la presentación de tus
              declaraciones bajo tu autorización.
            </li>
            <li>
              Con proveedores de servicios de confianza que nos ayudan a operar
              la plataforma (ej. alojamiento en la nube), bajo estrictos
        ...
        <section className="space-y-4 mb-8">
          ...
          <p>
            Tienes derecho a acceder, corregir, eliminar o limitar el uso de tu
            información personal. Puedes ejercer estos derechos en cualquier
        ...
        <section className="space-y-4 mb-8">
          ...
          <p>
            ...
            Puedes configurar tu navegador para rechazar las cookies, aunque
