...
import { Smartphone, BrainCircuit, PieChart, Upload, FileText, CheckCircle2, ScanLine } from "lucide-react";
    ...
    visual: (
      <div className="relative flex items-center justify-center h-full w-full bg-slate-100/50 rounded-lg overflow-hidden">
        ...
        <div className="absolute top-6 right-6 bg-white p-2.5 rounded-xl shadow-lg border border-slate-100 flex items-center gap-2 animate-bounce">
           ...
           <span className="text-[10px] font-bold text-slate-600 uppercase tracking-wider">O sube PDF</span>
        </div>
      </div>
    )
  },
        ...
        <div className="w-full max-w-[320px] bg-white rounded-xl shadow-xl border border-slate-100 overflow-hidden transform transition-all hover:scale-[1.02]">
          ...
          <div className="bg-slate-900 p-4 flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-[10px] text-slate-400 font-medium uppercase tracking-wider">Periodo</p>
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="flex items-end justify-center gap-6 h-28 border-b border-slate-100 pb-5">
               ...
               <div className="flex flex-col items-center gap-2 group w-16">
                  <span className="text-[10px] font-bold text-green-600 bg-green-50 px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity absolute -mt-6">S/ 12.5k</span>
               ...
               {/* Purchases Bar */}
               <div className="flex flex-col items-center gap-2 group w-16">
                  <span className="text-[10px] font-bold text-amber-600 bg-amber-50 px-1.5 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity absolute -mt-6">S/ 8.2k</span>
                  ...
                  <span className="text-xs font-medium text-slate-500">Compras</span>
               </div>
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-sm">
                <span className="text-slate-500 flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-green-500"></div>IGV Ventas</span>
                <span className="font-medium text-slate-700">S/ 2,250.00</span>
              </div>
              <div className="flex justify-between items-center text-sm">
                <span className="text-slate-500 flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-amber-400"></div>IGV Compras</span>
                <span className="font-medium text-slate-700">- S/ 1,476.00</span>
              </div>
              <div className="h-px bg-slate-100 my-2"></div>
              <div className="flex justify-between items-center">
                <span className="font-bold text-slate-800">IGV a Pagar</span>
                <span className="text-xl font-bold text-primary">S/ 774.00</span>
              </div>
            </div>
          </div>
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex items-start gap-4 relative z-10">
                  ...
                  <div>
                    <h3 className={cn("text-xl font-semibold mb-2 transition-colors", activeStep === index ? "text-primary" : "text-foreground")}>
                      {step.title}
                    </h3>
                ...
                <div className={cn(
                  ...
                  activeStep === index ? "max-h-[400px] opacity-100 mt-6 pb-2" : "max-h-0 opacity-0"
                )}>
          ...
          <div className="hidden lg:block relative h-[400px] lg:h-[500px] w-full perspective-1000">
             ...
             <Card className="relative h-full w-full overflow-hidden border-2 shadow-2xl bg-background/80 backdrop-blur transition-all duration-500 ease-in-out transform hover:scale-[1.02]">
               <CardContent className="h-full p-0 flex items-center justify-center bg-slate-50/50">
                 <div key={activeStep} className="w-full h-full p-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
